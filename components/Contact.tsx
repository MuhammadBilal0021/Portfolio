      ...
      <ScrollReveal>
        ...
        <div className="flex-responsive">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex-row" style={{ gap: "8px" }}
          >
        ...
        <div style={{ marginTop: "80px", textAlign: "center", color: "var(--text-muted)", fontSize: "14px" }}>
          <p>© {new Date().getFullYear()} Muhammad Bilal. Built with Next.js & Tailwind v4.</p>
        </div>
      </ScrollReveal>
    </section>
  );
